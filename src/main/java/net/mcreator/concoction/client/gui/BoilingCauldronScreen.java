...
public class BoilingCauldronScreen extends AbstractContainerScreen<BoilingCauldronMenu> {
	private final static HashMap<String, Object> guistate = BoilingCauldronMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public BoilingCauldronScreen(BoilingCauldronMenu container, Inventory inventory, Component text) {
