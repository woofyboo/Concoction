...
import net.mcreator.concoction.world.features.configurations.StructureFeatureConfiguration;
import net.mcreator.concoction.ConcoctionMod;

import com.mojang.serialization.Codec;

public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, ConcoctionMod.MODID);
