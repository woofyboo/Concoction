    ...
    public WeightedSoulsFluidType() {
        super(FluidType.Properties.create()
                ...
                .sound(SoundActions.BUCKET_EMPTY,
                        BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("concoction:soul_bucket_empty")))
                .sound(SoundActions.FLUID_VAPORIZE, SoundEvents.FIRE_EXTINGUISH));
    }

    // РЕГИСТРАЦИЯ КЛИЕНТСКИХ ЭКСТЕНШЕНОВ — НОВЫЙ СПОСОБ (без initializeClient)

    @SubscribeEvent
    public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
        event.registerFluidType(new IClientFluidTypeExtensions() {
            private static final ResourceLocation STILL_TEXTURE =
                    ResourceLocation.parse("concoction:block/weighted_souls");
            private static final ResourceLocation FLOWING_TEXTURE =
                    ResourceLocation.parse("concoction:block/weighted_souls_flow");
            ...
            public Vector3f modifyFogColor(Camera camera,
                ...
                // бирюзовый такой туманчик
                return new Vector3f(0f, 0.87058824f, 0.78431374f);
            }
            ...
            public void modifyFogRender(Camera camera,
                ...
                // небольшой плотный шарообразный туман
