...
public class SoakedRiceBlock extends FallingBlock {
	public static final MapCodec<SoakedRiceBlock> CODEC = simpleCodec(properties -> new SoakedRiceBlock());

	@Override
	public MapCodec<SoakedRiceBlock> codec() {
		return CODEC;
	}

	public SoakedRiceBlock() {
